...
export const en = {
  ...
  voiceDictateLabel: 'Dictate this shelf',
  voiceBeta: 'Beta',
  voiceDictateSub:
    'Live mic — speak what you see on this shelf (e.g. “two mayo, three milk, one jar of capers”). Edit the transcript, then review lines or save the shelf.',
  voiceMic: 'Mic',
  voiceStop: 'Stop',
  ...
  companionKicker: 'Live companion',
  companionTitle: 'Walk & talk inventory',
  companionSub:
    'Hold the phone, pick a shelf, and describe what you see. We match your local catalog, you confirm, then export the registered sheet.',
  companionCountingAt: 'Counting at',
  companionShelfTitle: 'Shelf: {place}',
  companionWalkTitle: 'Shelf walk companion',
  companionDraftPreview: 'Heard {n} product(s) on this shelf',
  companionMatchedAs: 'Catalog: {name}',
  companionNoMatch: 'No catalog match yet — confirm or add in review',
  companionSaveShelf: 'Save this shelf · next',
  companionFinishWalk: 'Review all ({n} lines)',
  companionSavedShelves: '{n} shelf section(s) saved',
  companionShelfLineCount: '{n} lines',
  companionShelfSaved: 'Saved {n} line(s) from {place}',
  companionEmptyWalk: 'Dictate at least one product before finishing',
  companionFootnote:
    'After review, confirmed lines are written to inventory. Voice walks open Export so you get the registered document.',
  ...
  videoDemo: 'Live companion',
  videoDemoSub: 'Mic · shelf by shelf · confirm · export',
  language: 'Language',
  ...
  capture: 'Capture',
  scanHub: 'Scan hub',
  scanHubSub: 'Photos, live mic companion, or type-to-count.',
  ...
  videoWalkthrough: 'Live mic companion (shelf walk)',
