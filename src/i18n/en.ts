...
export const en = {
  ...
  columnDragToReorder: 'Drag ⠿ to reorder',
  columnDragHintNearColumns: 'Drag ⠿ to reorder',
  columnReorderBtn: 'Reorder columns',
  columnReorderTitle: 'Reorder columns',
  columnReorderSub:
    'Use ▲ / ▼ to move columns. On desktop you can also drag ⠿ on the sheet headers.',
  columnReorderDone: 'Done',
  ...
  voiceBeta: 'Beta',
  voiceDictateSub:
    'Beta — we’re testing speech recognition. Speak what you see and say “and” between each item — that is how lines are split (e.g. “two mayo and three milk and one jar of capers”). Edit the transcript, then review lines or use as a single name.',
  voiceMic: 'Mic',
  voiceStop: 'Stop',
  ...
  simpCountPickCategory: 'Category',
  simpCountTotal: 'TOTAL: {amount} €',
  simpCountSwipeHint: 'Swipe right +1 · swipe left −1',
  simpCountColProduct: 'Product',
  simpCountColQty: 'Qty',
  simpCountColUnit: 'Unit',
  simpCountColUnitPrice: 'Unit € (0% tax)',
  simpCountColTotalPrice: 'Total € (0% tax)',
  simpCountCatStockValues: 'Stock values',
  simpCountCatAllItems: 'All items',
  simpCountAddProduct: 'Add product',
  simpCountHideProduct: 'Hide product',
  simpCountUnhideProduct: 'Unhide',
  simpCountShowHidden: 'Hidden {count}',
  simpCountAddName: 'Product name',
  simpCountAddNameFi: 'Finnish name (optional)',
  simpCountAddCategory: 'Category',
  simpCountAddUnit: 'Unit',
  simpCountAddPrice: 'Unit price (0% ALV)',
  simpCountAddSave: 'Add to list',
  simpCountAddCancel: 'Cancel',
  simpCountHideHint: 'Hidden items stay out of category lists until you unhide them here.',
  simpCountHiddenBadge: 'Hidden',
  simpCountSelectToHide: 'Select a product to hide',
  simpCountEdit: 'Edit list',
  simpCountEditHint:
    'Long-press a row for hide (−) and edit (✎) · Add product below · Done when finished',
  simpCountEditDetails: 'Edit details',
  ...
  simpCountPriceHistoryEmptyMonth: 'No price records for {month}.',
  simpCountPriceHistoryExport: 'Print / export',
  simpCountStockPrior: 'Prior: {amount} €',
  simpCountStockPriorNone: 'Prior: —',
  simpCountStockPriorUp: '↑ {amount} € vs prior',
  simpCountStockPriorDown: '↓ {amount} € vs prior',
  simpCountStockPriorFlat: '= same as prior',
  simpCountStockSharePct: '{pct} %',
  simpCountExtraSettings: 'Extra settings',
  simpCountExportTitle: 'Export',
  simpCountExportSub: 'PDF or Excel — filled list, or a blank count sheet for the chef.',
  simpCountExportScopeCategory: 'This category',
  simpCountExportScopeAll: 'All items',
  simpCountExportScopeBlank: 'Blank sheet',
  simpCountExportScopeBlankSub: 'Same products, empty qty — print, fill by hand, scan later',
  simpCountExportPdf: 'PDF',
  simpCountExportExcel: 'Excel',
  simpCountExportGo: 'Export',
  simpCountExportBusy: 'Preparing export…',
  simpCountExportDone: 'Export ready',
  simpCountExportFailed: 'Export failed',
  simpCountBackToMore: 'Back to More',
  simpCountAllHiddenTitle: 'All products in this list are hidden',
  simpCountAllHiddenSub: 'Open Hidden to bring items back for this month.',
  simpCountHiddenEmpty: 'No hidden products.',
  simpCountUnhideAll: 'Unhide all',
  simpCountScanList: 'Scan list photo',
  simpCountScanListSub:
    'Photo a count sheet or a supplier order. Match catalog duplicates, then choose inventory or price records.',
  simpCountScanCamera: 'Take photo',
  simpCountScanLibrary: 'Choose photo',
  simpCountScanBusy: 'Reading list…',
  simpCountScanNeedPermission: 'Allow camera or photo access to scan a list.',
  simpCountScanKindTitle: 'What kind of list?',
  simpCountScanKindCount: 'Count / stock list',
  simpCountScanKindCountSub: 'Digitize quantities → validate → inventory',
  simpCountScanKindSupplier: 'Supplier order / price list',
  simpCountScanKindSupplierSub:
    'Use listed prices as reference — add to inventory or keep records only',
  simpCountPriceHistory: 'Price records',
  simpCountPriceHistoryEmpty: 'No supplier price records yet.',
  simpCountPriceHistoryDelta: '{from} → {to} €',
  supplierOrderKicker: 'Supplier order',
  supplierOrderTitle: 'Supplier prices',
  supplierOrderSub:
    'Review OCR rows, then add to inventory or only keep price history for later months.',
  supplierOrderMeta: '{priced} priced of {n} · month {month}',
  supplierOrderMatched: 'Catalog: {name}',
  supplierOrderNoMatch: 'No strong match — will create if you add to inventory',
  supplierOrderPricePh: 'Unit € (0% ALV)',
  supplierOrderQtyPh: 'Qty (optional)',
  supplierOrderNeedPrice: 'Include at least one row with a unit price.',
  supplierOrderAddInventory: 'Add to inventory',
  supplierOrderAddInventorySub:
    'Write prices (and qty when set) into stock for the selected place',
  supplierOrderRecordsOnly: 'Keep in price records only',
  supplierOrderRecordsOnlySub:
    'Do not change stock — save for month-to-month price history',
  supplierOrderSavedTitle: 'Saved',
  supplierOrderSavedRecords: 'Supplier prices saved to your price records.',
  supplierOrderSavedInventory:
    'Inventory updated ({written} lines, {created} new). Prices also saved to records.',
  supplierOrderFailed: 'Could not save supplier order.',
  simpCountCatDairy: 'Dairy products',
  simpCountCatVegetables: 'Vegetables',
  simpCountCatSeafood: 'Fish & seafood',
  simpCountCatMeat: 'Meat',
  simpCountCatFrozen: 'Frozen foods',
  simpCountCatDryGoods: 'Dry storage',
  simpCountCatKitchenAlcohol: 'Kitchen alcohol',
  simpCountCatOther: 'Other',
  simpCountCatWaste: 'Waste',
  simpCountStockTitle: 'Inventory {year}',
  simpCountStockFoodValue: 'Food stock value',
  simpCountStockPrint: 'Print',
  simpCountStockColCategory: 'Category',
  simpCountStockColTotal: 'Total',
  simpCountStockColShare: 'Share',
  simpCountStockEmptyDash: '—',
  simpCountEmptyTitle: 'No items in this category yet',
  simpCountEmptySub: 'Add products with Edit, or scan a list photo.',
  ...
  simpCountGameMode: 'Play',
  simpCountGameBack: 'Go back to\nmain view',
  simpCountGameClear: 'Clear quantity',
  simpCountGamePrev: 'Previous item',
  simpCountGameNext: 'Next item',
  simpCountGameNextCelebrate: 'Save and next',
  simpCountGameNav: 'Jump items',
  simpCountGameEmpty: 'No items to count in this category.',
  simpCountGameProgress: '{n} of {total}',
  simpCountGameSwipeHint: 'Swipe this card right → next · left ← previous',
  simpCountGameSuccess: '🔥 On fire!',
  ...
  refreshAppSub:
    'Reload the latest Invis build — useful when this is installed as an app on your phone.',
  refreshAppBusy: 'Refreshing…',
