...
export const en = {
  ...
  simpCountEditHint: 'Tap − to hide · Done via ✎ · Long-press an item to edit',
  ...
  simpCountScanListSub:
    'Photo a prior or current count list. We’ll match the catalog for duplicates / nicknames, then let you add new items.',
