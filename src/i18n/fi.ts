...
export const fi: Messages = {
  ...
  simpCountCatAllItems: 'Kaikki tuotteet',
  simpCountAddProduct: 'Lisää tuote',
  simpCountHideProduct: 'Piilota tuote',
  simpCountUnhideProduct: 'Näytä',
  simpCountShowHidden: 'Piilotetut {count}',
  simpCountAddName: 'Tuotteen nimi',
  simpCountAddNameFi: 'Suomenkielinen nimi (valinnainen)',
  simpCountAddCategory: 'Kategoria',
  simpCountAddUnit: 'Yksikkö',
  simpCountAddPrice: 'Yksikköhinta (0 % ALV)',
  simpCountAddSave: 'Lisää listaan',
  simpCountAddCancel: 'Peruuta',
  simpCountHideHint: 'Piilotetut tuotteet eivät näy kategorioissa ennen kuin näytät ne täällä.',
  simpCountHiddenBadge: 'Piilotettu',
  simpCountSelectToHide: 'Valitse piilotettava tuote',
  simpCountEdit: 'Muokkaa listaa',
  simpCountEditHint:
    'Pitkä painallus: piilota (−) ja muokkaa (✎) · Lisää tuote alla · Valmis lopettaa',
  simpCountEditDetails: 'Muokkaa tietoja',
  ...
  simpCountAddAliasesPh: 'mayo, majoneesi, …',
  simpCountPriceHistoryEmptyMonth: 'Ei hintatietoja kuukaudelle {month}.',
  simpCountPriceHistoryExport: 'Tulosta / vie',
  simpCountStockPrior: 'Edellinen: {amount} €',
  simpCountStockPriorNone: 'Edellinen: —',
  simpCountStockPriorUp: '↑ {amount} € vs edellinen',
  simpCountStockPriorDown: '↓ {amount} € vs edellinen',
  simpCountStockPriorFlat: '= sama kuin edellinen',
  simpCountStockSharePct: '{pct} %',
  simpCountExtraSettings: 'Lisäasetukset',
  simpCountExportTitle: 'Vie',
  simpCountExportSub:
    'PDF tai Excel — täytetty lista, tai tyhjä laskentapohja keittiöön.',
  simpCountExportScopeCategory: 'Tämä kategoria',
  simpCountExportScopeAll: 'Kaikki tuotteet',
  simpCountExportScopeBlank: 'Tyhjä pohja',
  simpCountExportScopeBlankSub:
    'Samat tuotteet, tyhjät määrät — tulosta, täytä käsin, skannaa myöhemmin',
  simpCountExportPdf: 'PDF',
  simpCountExportExcel: 'Excel',
  simpCountExportGo: 'Vie',
  simpCountExportBusy: 'Valmistellaan vientiä…',
  simpCountExportDone: 'Vienti valmis',
  simpCountExportFailed: 'Vienti epäonnistui',
  simpCountBackToMore: 'Takaisin Lisää-valikkoon',
  simpCountAllHiddenTitle: 'Kaikki tuotteet on piilotettu',
  simpCountAllHiddenSub: 'Avaa Piilotetut tuodaksesi tuotteet takaisin.',
  simpCountHiddenEmpty: 'Ei piilotettuja tuotteita.',
  simpCountUnhideAll: 'Näytä kaikki',
  simpCountScanList: 'Skannaa lista',
  simpCountScanListSub:
    'Kuvaa laskentalista tai tavarantoimittajan tilaus. Tunnista duplikaatit, sitten inventaario tai hintahistoria.',
  simpCountScanCamera: 'Ota kuva',
  simpCountScanLibrary: 'Valitse kuva',
  simpCountScanBusy: 'Luetaan listaa…',
  simpCountScanNeedPermission: 'Salli kamera tai kuvat listan skannaamiseen.',
  simpCountScanKindTitle: 'Millainen lista?',
  simpCountScanKindCount: 'Laskenta / varastolista',
  simpCountScanKindCountSub: 'Määrät → tarkistus → inventaario',
  simpCountScanKindSupplier: 'Toimittajan tilaus / hinnasto',
  simpCountScanKindSupplierSub:
    'Hinnat referenssiksi — inventaarioon tai vain hintahistoriaan',
  simpCountPriceHistory: 'Hintatiedot',
  simpCountPriceHistoryEmpty: 'Ei toimittajahintoja vielä.',
  simpCountPriceHistoryDelta: '{from} → {to} €',
  supplierOrderKicker: 'Toimittajatilaus',
  supplierOrderTitle: 'Toimittajahinnat',
  supplierOrderSub:
    'Tarkista OCR-rivit. Lisää inventaarioon tai tallenna vain hintahistoriaan myöhempää vertailua varten.',
  supplierOrderMeta: '{priced} hinnoiteltua / {n} · kuukausi {month}',
  supplierOrderMatched: 'Katalogi: {name}',
  supplierOrderNoMatch: 'Ei vahvaa osumaa — luodaan jos lisäät inventaarioon',
  supplierOrderPricePh: 'Yks. € (0 % ALV)',
  supplierOrderQtyPh: 'Määrä (valinnainen)',
  supplierOrderNeedPrice: 'Valitse vähintään yksi rivi jolla on yksikköhinta.',
  supplierOrderAddInventory: 'Lisää inventaarioon',
  supplierOrderAddInventorySub:
    'Kirjaa hinnat (ja määrät jos annettu) valittuun paikkaan',
  supplierOrderRecordsOnly: 'Vain hintahistoriaan',
  supplierOrderRecordsOnlySub:
    'Älä muuta varastoa — tallenna kuukausivertailua varten',
  supplierOrderSavedTitle: 'Tallennettu',
  supplierOrderSavedRecords: 'Toimittajahinnat tallennettu hintahistoriaan.',
  supplierOrderSavedInventory:
    'Inventaario päivitetty ({written} riviä, {created} uutta). Hinnat myös historiassa.',
  supplierOrderFailed: 'Toimittajatilausta ei voitu tallentaa.',
  ...
  simpCountEmptySub: 'Lisää tuotteita Muokkaa-tilassa tai skannaa listakuva.',
  ...
  simpCountGameSwipeHint: 'Pyyhkäise tätä korttia oikealle → seuraava · vasemmalle ← edellinen',
