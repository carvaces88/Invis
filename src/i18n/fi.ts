...
export const fi: Messages = {
  ...
  simpCountEditHint: 'Napauta − piilottaaksesi · ✎ lopettaa · pitkä painallus muokkaa',
  ...
  simpCountScanListSub:
    'Kuvaa aiempi tai nykyinen laskentalista. Tunnistamme katalogin osumat (duplikaatit / lempinimet) ja voit lisätä uudet.',
